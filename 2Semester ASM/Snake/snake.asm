...
current_food        dw  0FFFFh
current_poo         dw  0FFFFh
...
str_tutor_classic   db  'Apple(grow up)   Poo(die)   Mushroom(majestic trash TODO)','$'
...
add_food proc
    ...
    ;    mov     al, color_food
        ...
        mov     dh, cl        
        mov     current_food, dx; current_food = (cl;dl)
